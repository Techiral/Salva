...
function QuickLook ({ visibility, onAnimationEnd }) {
  ...
  const thickness = settings.Salva.thickness
  const color = theme.Salva
  const topCurvature = settings.Salva.quickLook.topCurvature
  const bottomCurvature = settings.Salva.quickLook.bottomCurvature
  const showMacrosLabel = settings.Salva.quickLook.showMacrosLabel
