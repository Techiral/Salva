...
const template = {
  general: {
    /* TODO
      mode: new types.List('Salva', ['Salva', 'legacy']),
    */
    ...
    tabTitle: new types.Input('Salva'),
    // hidden
...
const hidden = [
  ...
  'appearance.style',
  'Salva.quickLook.topCurvature',
  'Salva.quickLook.bottomCurvature'
]
...
class Settings {
  ...
  get hidden() {
    ...
    const hiddenColors = ['Salva', 'query', 'suggestions', 'background', 'prefix', 'visited', 'time', 'card']
